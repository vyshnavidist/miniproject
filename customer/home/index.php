...
<html lang="en">
    <head>
        ...
        <title>	Tooplates Little Fashion</title>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php">
                        <strong><span>VSR</span> Group</strong>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../displaycategory.php">Category</a>
                            </li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <a href="about.html" class="btn custom-btn" id="story">Learn more about us</a>
                                </div>
                            </div>
                        </div>
                    </div>
