...
?>
          <div class="radio-input">
            ...
            Pay Rs.<?php echo $advance;?> with credit card
          </div>
        </label>
        ...
        <label for="paypal" class="method paypal">
          ...
          <div class="radio-input">
            <input id="paypal" type="radio" name="payment">
             Pay Rs.<?php echo $advance;?> with pay pal
          </div>
        </label>
      </div>
        ...
        <div class="column-1">
          ...
          <div class="small-inputs">
            <div> 
              ...
              <input type="text" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" maxlength="2" minlength="1" id="date" name="Cmm" placeholder="MM " /> 
