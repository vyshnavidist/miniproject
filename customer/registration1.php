...
$dao=new DataAccess();
$elements=array(
        "username"=>"","phonenumber"=>"","email"=>"","phone"=>"","password"=>"","cpassword"=>"");


$form=new FormAssist($elements,$_POST);
//$file=new FileUpload();
$labels=array('username'=>"Name","email"=>"Email Id","phone"=>"Phone Number","password"=>"Password","cpassword"=>"Confirm Password");
                ...
                <div class="card-body">
					...
					<p><?php if(isset($msg)) echo $msg; ?></p>
                        <div class="input-group">
                             <?= $form->textBox('username',array("placeholder"=>"Name")); ?>
                        ...
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" name="login" type="submit"><a href="login.php">Login</a></button>
                               </div>
                    </form>
                </div>
            </div>
